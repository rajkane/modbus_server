...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lw_notification.setProperty("showDropIndicator", False)
        ...
        self.lw_notification.setResizeMode(QtWidgets.QListView.Adjust)
        self.lw_notification.setBatchSize(10000)
        self.lw_notification.setWordWrap(True)
        ...
        self.le_ip.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
